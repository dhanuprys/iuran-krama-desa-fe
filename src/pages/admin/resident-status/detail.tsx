                ...
                <LayoutContentHeader
                    header={
                        <div>
                            ...
                            <LayoutContentSubHead>
                                Informasi detail status kependudukan.
                            </LayoutContentSubHead>
                        </div>
                    }
                />
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <div className="mb-2 text-sm font-medium text-muted-foreground">ID</div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                <div className="text-sm font-medium text-muted-foreground">Nama Status</div>
                                <div className="font-semibold">{status.name}</div>
                            </div>
                            <div>
                                <div className="text-sm font-medium text-muted-foreground">Jumlah Iuran</div>
