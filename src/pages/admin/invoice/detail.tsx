...
export default function AdminInvoiceDetailPage() {
  ...
  useEffect(() => {
    const fetchInvoice = async () => {
      if (!id) return;
      try {
        const response = await adminInvoiceService.getInvoice(parseInt(id));
    ...
    return (
      <LayoutContent>
        <LayoutContentBody>
          ...
          <Button className="mt-4" onClick={() => navigate('/admin/invoice')}>
      ...
      <LayoutContentHeader
        ...
        info={
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={() => navigate(`/admin/invoice/${invoice.id}/edit`)}>
